...
-- wibox needs to be included now
wibox = require("wibox")
-- Gears for the wallpaper
gears = require("gears")
...
--beautiful.init("/home/jon/.config/awesome/themes/dustocean/theme.lua")
beautiful.init("/home/jon/.config/awesome/themes/mytheme/theme.lua")
...
--ConkyForecast location=USFL0311
...
--	memwidget, ramicon, separator,
--	cpuwidget, cpuicon, separator,
--	mpdwidget, mpdicon, separator,
--        s == 1 and right_mysystray or nil,
--        mytasklist[s],
...
globalkeys = awful.util.table.join(
    ...
    -- MPD Control Test
    awful.key({            }, "XF86AudioPlay",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost toggle") end),
    awful.key({            }, "XF86AudioPrev",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost prev") end),
    awful.key({            }, "XF86AudioNext",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost next") end),
    awful.key({            }, "XF86AudioLowerVolume",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost volume -1") end),
    awful.key({            }, "XF86AudioRaiseVolume",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost volume +1") end),
    awful.key({            }, "XF86AudioMute",   function () awful.util.spawn("ncmpcpp -h ArchieMPD@localhost stop") end),
    awful.key({            }, "XF86Tools",   function () awful.util.spawn("urxvt -geometry 130x44 -e ncmpcpp -h ArchieMPD@localhost") end),

    -- Scrot control with the Keyboard
    awful.key({            }, "Print",   function () awful.util.spawn("scrot -e 'mv $f ~/Pictures/screenshots/ 2>/dev/null'") end),
    -- awful.key({ modkey     }, "Print",   function () awful.util.spawn("scrot -se 'mv $f ~/Pictures/screenshots/ 2>/dev/null'") end),
    
    -- Open '/home/jon' in Thunar
    awful.key({            }, "XF86HomePage",   function () awful.util.spawn("thunar") end),
    awful.key({            }, "XF86Search",   function () awful.util.spawn("catfish") end),
...
-- Move windows one workspace Left/Right
-- "<modkey><,>" Moves Left
-- "<modkey><.>" Moves Right
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     focus = true,
                     keys = clientkeys,
		     size_hints_honor = false, -- Get rid of if problems arise!
...
--Attempt to run programs at launch
awful.util.spawn_with_shell("numlockx")
--awful.util.spawn_with_shell("devmon -s --exec-on-drive thunar %d --exec-on-disc thunar %d")
